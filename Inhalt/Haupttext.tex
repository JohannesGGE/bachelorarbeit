...
\begin{itemize}
	\item Die Entwickung eines Standards ist mühsam und Zeitaufwendig, kann aber bei Erfolg einiges möglich machen
	\item In dieser Arbeit wurde aufgezeigt, wie Lösungen aussehen können und es wurde ein konkreter Vorschlag für eine Erweiterung gemacht
	\item Basieredn darauf könnte ein Internet Draft geschrieben werde, welcher im Standardisierungsporzess zu einem RFC wird.
	\begin{itemize}
		\item 
	\end{itemize}
\end{itemize}
