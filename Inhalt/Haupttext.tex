...
Um einen konkreten Vorschlag zu machen, wie eine interoperable Lösung aussheen könnte betrachten wir das Fazit des letzen kapitel und die Erkentniise aus der Nextcloud Mail App

Mit den zusammengetragenen Informationen ist es möglich eine Standarderweiterung vorzuschlagen, die wie folgt aussihet:

Es gibt nicht die EINE Lösung, aber das sehe ich aus den und den Punkten, als die beste an.

Nur das in RFC aufnehmen, was bereits etabliert, sonst bhindert dieser Teil das ganze Packet
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Welche/n Lösungsansatz wird angestrebt?
		\item Qick Flag Changes Resynchronisation CONDSTORE and Quick Mailbox Resync QRESYNC
		\item 
	\end{itemize}
\end{itemize}
