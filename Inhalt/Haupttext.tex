...
Alle Aktionen könnnen ausgeführt werden, aber das Zurückstellen noch nicht, nur mit manuellem aufwand, aber nicht automatisertem zurückschieben
...
\begin{itemize}
	...
	\end{itemize}
	\item Warum braucht es dafür eine Erweirerung von IMAP?
	\begin{itemize}
		\item Weil Nutzung von mehreren Clients (Zahlen)
		\item Wenn mehrere Clients von unterschiedlichen Anbietern wird meistens IMAP genutzt
		\item Weil IMAP ein offener Standard für Verwaltung von E-Mail management und deshlab sollte hier durch eine offener erweiterung das ganze interoperabel gelöst werden. Damit kann dann alle Clients nutzen
	\end{itemize}
\end{itemize}

Im nächsten Kapitel werden die existierenden Lösungen zu dier Funtionalität betrchtet und geschaut, wie diese sich verhalten und ob es evt schon interoperabilität in Teilen gibt.
