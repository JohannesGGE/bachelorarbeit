...
\begin{itemize}
	...
	\item S/Smime könnte kaputt gehen?
	\begin{itemize}
		\item S/SMIME kann header wrappen, damit diese durch S/MIME geschützt sind \cite{melnikovInternetMessageAccess2021}
		\item Standardmäßig ist aber nur der Body und coentet related header durch durch S/MIME geschützt.
		\item auch Extenstions wie \enquote{Securing Header Fields with S/MIME} basieren auf der auswahl der bestimmten header, welche geschützt werden. \cite{cailleuxSecuringHeaderFields2015}
		\item Somit wird die Verschlüsselung und Signatur durch extra Header nicht kaputt gemacht.
	\end{itemize}
\end{itemize}
...
In Keyword und Header Ansatz und Metadata, wenn nciht verschoben ist zwar ein Indikator, welche Email \hl{gesnoozt} ist, allerdings kann es in Email Clients, welche das Feature nicht implementieren oder \hl{Labels} gar nicht anzeigen zu verwirrung kommen, da die Emails nicht verschoben ... \cite{SnoozedEmailsStay2022} (Beispiel Gmail)
